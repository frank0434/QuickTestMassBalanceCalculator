...
crop_para <- crop_para %>% 
  mutate(Harvested.parameter = ifelse(is.na(Harvested.parameter),
         ...
         Crop_name_display = gsub("(_)(Autumn|Summer|Spring|Winter)",
                                  " - \\2 planting", Crop),
         Crop_name_display = case_when(Crop_name_display == "Baby_Spinach" ~ "Baby Spinach",
         Crop_name_display == "Wheat - Autumn planting" ~ "Wheat - Autumn sown", 
         Crop_name_display == "Wheat - Spring planting" ~ "Wheat - Spring sown"))  
```
